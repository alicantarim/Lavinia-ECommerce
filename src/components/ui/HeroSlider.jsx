...
const HeroSlider = () => {
  const slides = [
    ...
    },
    {
      ...
      description:
        "Discover our latest winter collection with amazing discounts on selected items.",
    },
    {
      id: 3,
      ...
      description:
        "Explore our new spring collection featuring vibrant colors and modern designs.",
    },
  ];
