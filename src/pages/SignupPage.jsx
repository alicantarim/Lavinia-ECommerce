  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1950&q=80')",
        }}
      >
        <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
          <div>
            ...
            <p className="max-w-xl mt-3 text-gray-300">
              Create an account and get access to exclusive deals, personalized
                    ...
                    <input
                      ...
                      {...register("password", {
                        ...
                        pattern: {
                          ...
                          message:
                            "Password must contain at least 8 characters, including numbers, lowercase, uppercase, and special characters",
                        },
                      })}
                      className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      ...
                      <input
                        ...
                        {...register("tax_no", {
                          ...
                          pattern: {
                            value: taxPattern,
                            message:
                              "Please enter a valid tax number (Format: TXXXXVXXXXXX)",
                          },
                        })}
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
